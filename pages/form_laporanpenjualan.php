<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item"><a href="?page=datapenjualan"><i class="fas fa-file-invoice-dollar"></i> Data Penjualan</a></li>
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-file"></i> Form Laporan Penjualan</li>
  </ol>
</nav>

<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>Form Laporan Penjualan</h4></div>
	...
	<div class="form-container">
		<div class="row">
			<div class="col-md-6 offset-md-3 offset-form">
				<h6><i class="fas fa-list-alt"></i> Lengkapi form ini untuk mencetak laporan penjualan</h6>
					<form action="" method="POST" target="blank" id="form_laporanpenjualan">
	          	  ...
	          	  <div class="form-check">
					  ...
					  <div class="form-group row">
					    ...
					    <div class="col-sm-9">
					      ...
					      <?php 
					      	$sql_peg = mysqli_query($conn, "SELECT username, nama_peg FROM tbl_pegawai") or die ($conn->error);
					      	while($data_peg = mysqli_fetch_array($sql_peg)) {
					       ?>
					       		<option value="<?php echo $data_peg['username']; ?>"><?php echo $data_peg['nama_peg']; ?></option>
					      <?php } ?>
					      </select>
					    </div>
					  </div>
...
<script>
	...
	function cetak(action) {
		...
		$.ajax({
			url: 'ajax/cek_laporan.php?page=laporan_penjualan',
			method: 'POST',
			data: form_data,
 ...
 // onclick="submit_formlaporan('laporan/?page=laporan_penjualan_rangkuman')"
	$("#tbl_cetakrangkuman").click(function(){
		cetak('laporan/?page=laporan_penjualan_rangkuman');
	});

	$("#tbl_cetakdetail").click(function(){
		cetak('laporan/?page=laporan_penjualan_detail');
	});
</script>